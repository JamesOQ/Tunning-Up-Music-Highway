...
Aknowledgements: First, we would like to thank everyone at The Erdős Institute for making this project possible and giving us the means and education to complete this project. Also, we would like to thank Steven Gubkin for the helpful comments and feedback. Finally, we are incredibly grateful for all the advice, encouragement, and guidance from our group mentor Greg Taylor.
